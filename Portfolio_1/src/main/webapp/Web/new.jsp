        ...
        <%@ include file="menu.jsp" %>
            ...
            <div class="container-fluid bg-primary p-2">
                <ul class="nav nav-pills justify-content-center ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white " href="news.jsp?title=정치">정치</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link text-white " href="news.jsp?title=사회">사회</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white " href="news.jsp?title=경제">경제</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white " href="news.jsp?title=생활문화">생활문화</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white " href="news.jsp?title=국제">국제</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white " href="news.jsp?title=스포츠">스포츠</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active text-white " href="new.jsp">최신</a>
                    </li>
                </ul>
            </div>
            ...
            <sql:query var="rs" dataSource="${dataSource }">
                select * from newsDB order by updatetime desc
            </sql:query>
...
@media ( max-width : 992px) {
    ...
    function newsDelete(id) {
        if (confirm('정말로 이 기사를 삭제하시겠습니까?')) {
            window.location.href = 'deleteNews.jsp?id=' + id;
        }
    }
