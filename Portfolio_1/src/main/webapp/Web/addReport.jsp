    ...
    <body>
        <%@ include file="menu2.jsp" %>
            <div class="container-fluid">
                <form action="./processAddReport.jsp" method="post"  enctype="multipart/form-data" name="newReport">
                    <div class="row">
                        <div class="offset-xl-2 col-4 mr-auto my-3">TV 홈 > 뉴스 > <span class="font-weight-bold">제보</span>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 my-3 ">
                                    <input type="tel" id="phone1" name="phone1" maxlength="3"
                                        class="phone-input bg-light rounded-lg " required>- <input type="tel"
                                        id="phone2" name="phone2" maxlength="4" class="phone-input bg-light rounded-lg"
                                        required>-
                                    <input type="tel" id="phone3" name="phone3" maxlength="4"
                                        class=" phone-input bg-light round ed-lg" required>
                                </div>
                                <div class="col-12 mb-2 ">
                                    <input type="text"  id="title" name="title" placeholder="제목을 입력해주세요." class="bg-light w-100 form-control" required>
                                </div>
                                <div class="col-12 mb-3 mt-2 ">
                                    <textarea class="form-control bg-light" aria-label="With textarea" id="ReportText"
                                        name="ReportText" placeholder="내용을 입력해주세요." rows="5"></textarea>
                                </div>
                    ...
                    <div class="col-12 text-center">
                           <p class="p-3 mr-1">개인정보 제공에 동의하시겠습니까? <input type="checkbox" required>동의함</p>
                        </div>
                        <div class="col-12 text-center">
                            <input type="submit" class="btn btn-primary w-25 p-3 " value="제보하기"></input>
                        </div>
                    </div>
                </form>
            </div>
